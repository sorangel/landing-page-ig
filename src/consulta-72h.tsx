    ...
    <section className="pt-20 pb-16 md:pt-28 md:pb-20 bg-white">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight" style={{ color: BLUE }}>
              Profesionales en inmigración que sí te entienden.
            </h1>
            <h2 className="mt-4 text-xl md:text-2xl text-gray-800">
              Claridad migratoria en ≤72 horas. Consultores certificados en California, documentos bajo el método 'Cero Errores' IGW 247™ y acceso a representación legal nacional.
            </h2>
            <div className="mt-8">
              <button
                onClick={onCta}
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow">
            <div className="text-sm font-semibold mb-2" style={{ color: RED }}>Paso 2</div>
            <h4 className="text-xl font-bold mb-2">Formulación - ≤72h</h4>
            <p className="text-gray-700">Recibes tu Mapa de Ruta Personal™: checklist de documentos, cronograma, presupuesto y análisis de riesgos.</p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow">
            <div className="text-sm font-semibold mb-2" style={{ color: RED }}>Bonus</div>
            <h4 className="text-xl font-bold mb-2">WhatsApp SOS 30 días</h4>
            <p className="text-gray-700">Incluye 30 días de soporte WhatsApp SOS.</p>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="rounded-3xl p-8 md:p-12 shadow border" style={{ borderColor: '#E5E7EB' }}>
          <h3 className="text-3xl font-bold mb-4" style={{ color: BLUE }}>Método IGW 247™: Precisión Digital</h3>
          <p className="text-lg text-gray-800">
            Doble validación con un checklist de 247 puntos críticos. Si cometemos un error en la preparación, reprocesamos sin costo y bonificamos tu consulta. Tu tranquilidad no es negociable.
          </p>
        </div>
      </div>
    </section>
...
function Locations() {
  const item = (city: string) => (
    <div className="bg-white rounded-2xl p-6 shadow text-center">
      <span className="inline-block text-sm font-semibold tracking-wide" style={{ color: BLUE }}>Oficina</span>
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-5xl">
        <h3 className="text-2xl md:text-3xl font-bold text-center mb-8" style={{ color: BLUE }}>Nuestras ubicaciones</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {item('Miami, FL')}
          {item('Los Angeles, CA')}
          {item('Ontario, CA')}
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-10">
        <p className="text-sm leading-relaxed opacity-90">
          IGW no es un bufete y no presta servicios legales; brinda consultoría y coordinación. La representación ante USCIS/EOIR la realiza un abogado licenciado o un representante acreditado, según corresponda. 'Cero errores' aplica a documentos preparados por IGW bajo IGW 247™; no garantiza resultados ante autoridades. Los SLAs son internos.
        </p>
      </div>
    </footer>
  );
    ...
    <section id="formulario" className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="mb-8 text-center">
          <h3 className="text-3xl md:text-4xl font-bold" style={{ color: BLUE }}>Reserva tu Consulta 2FT™</h3>
          <p className="mt-3 text-gray-700">Completa el formulario para agendar y recibir tu Mapa de Ruta en ≤72h.</p>
        </div>
        <form
          ref={formRef}
          method="GET"
          // En este MVP redirigimos a schedule.html con datos + UTM para seguimiento
          action={`/schedule.html${utmQuery ? '?' + utmQuery : ''}`}
        ...
        >
          ...
          <div>
            ...
            <select name="plan" required className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 ring-igw-red">
          ...
          <p className="text-xs text-gray-500 mt-2">Tus datos se usarán exclusivamente para brindarte el servicio solicitado.</p>
        </form>
      </div>
    </section>
  );
    ...
    <header className="bg-white shadow">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <a href="/" aria-label="Volver a la landing principal">
            <img src="https://res.cloudinary.com/dqqabrluc/image/upload/v1756677682/logo-immigrant_iankzn.avif" alt="Immigrant Gateway" className="h-10 w-auto" />
          </a>
        </div>
        <div className="flex items-center gap-3">
          <a href="/" className="text-sm md:text-base font-medium text-gray-700 hover:text-gray-900 underline underline-offset-4" aria-label="Ir a la landing principal">
            Volver a la landing
          </a>
          <a href="#formulario" className="hidden md:inline-block px-5 py-2 rounded-full text-white font-medium" style={{ backgroundColor: RED }}>
            Agenda en 72h
          </a>
        </div>
      </div>
